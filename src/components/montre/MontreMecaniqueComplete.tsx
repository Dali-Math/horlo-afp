...
const ComparaisonSection = () => {
  return (
    <Card gradient="from-slate-900 to-indigo-900 border-indigo-700">
      <h2 className="text-3xl font-bold text-white mb-4">Comparaison</h2>
      <div className="grid md:grid-cols-3 gap-4">
        <div className="bg-amber-900/50 rounded-lg p-4">
          <h3 className="font-bold text-amber-300">Mécanique</h3>
          <ul className="text-sm text-slate-200 space-y-1">
            <li>✓ Aucune batterie</li>
            <li>✓ Artisanat</li>
            <li>✓ Durabilité</li>
            <li>✗ Moins précis</li>
          </ul>
        ...
        <div className="bg-blue-900/50 rounded-lg p-4">
          <h3 className="font-bold text-blue-300">Quartz</h3>
          <ul className="text-sm text-slate-200 space-y-1">
            <li>✓ Très précis</li>
            <li>✓ Abordable</li>
            <li>✓ Peu d'entretien</li>
            <li>✗ Nécessite pile</li>
          </ul>
        </div>
        <div className="bg-purple-900/50 rounded-lg p-4">
          <h3 className="font-bold text-purple-300">Smart</h3>
          <ul className="text-sm text-slate-200 space-y-1">
            <li>✓ Multifonction</li>
            <li>✓ Connectivité</li>
            <li>✓ Personnalisable</li>
            <li>✗ Batterie quotidienne</li>
          </ul>
        </div>
      </div>
    </Card>
...
export function MontreMecaniqueComplete() {
  ...
  const sections = {
    ...
    comparaison: <ComparaisonSection />,
