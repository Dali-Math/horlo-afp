...
const MemoryGame6497: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-10 px-4 min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">

      {/* Header */}
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-amber-800 mb-2">Mouvement 6497</h1>
        <p className="text-lg text-amber-700">Memory Game - Cartes mémoire horlogères</p>
      </div>
      ...
      {!gameOver && !win && (
        <motion.div 
          ...
          className="text-2xl font-bold text-[#E2B44F] mb-6 bg-gradient-to-r from-amber-50 to-orange-50 px-6 py-3 rounded-xl shadow-md border-2 border-[#E2B44F]"
        >
      ...
      <motion.div 
        ...
        className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-7 gap-3 md:gap-4 max-w-6xl"
      >
        <AnimatePresence>
              ...
              >
                ...
                <div className="flip-card-back bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-[#E2B44F] flex flex-col items-center justify-center p-2 shadow-xl">
                  <div className="relative w-12 h-12 md:w-16 md:h-16 mb-1">
                    <div className="w-full h-full bg-gradient-to-br from-amber-100 to-amber-200 rounded-lg flex items-center justify-center border-2 border-amber-300">
