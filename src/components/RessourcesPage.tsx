...
const RessourcesPage: React.FC = () => {
  ...
  const getBadgeColor = (badge?: string) => {
    switch (badge) {
      case 'Nouveau': return 'bg-green-900 text-green-300 border-green-700';
      case 'Populaire': return 'bg-blue-900 text-blue-300 border-blue-700';
      case 'Premium': return 'bg-yellow-900 text-yellow-300 border-yellow-700';
      case 'Certifié': return 'bg-purple-900 text-purple-300 border-purple-700';
  ...
  const getNiveauColor = (niveau?: string) => {
    switch (niveau) {
      ...
      case 'Avancé': return 'text-orange-400';
  ...
  const ResourceCard: React.FC<{ resource: Resource }> = ({ resource }) => {
    const CardContent = (
      <div className="bg-slate-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-700 hover:border-blue-500 group">
        <div className="relative">
          <img 
            ...
            onError={(e) => {
              ...
              target.src = '/imgs/mouvements_header.png';
            }}
          />
          <div className="absolute top-3 left-3 flex gap-2">
            {resource.badge && (
              <span className={`px-2 py-1 rounded-full text-xs font-semibold border ${getBadgeColor(resource.badge)}`}>
                {resource.badge}
              </span>
            )}
          ...
          <div className="absolute top-3 right-3">
            <div className="flex items-center gap-1 bg-black/40 backdrop-blur-sm text-white px-2 py-1 rounded-full text-xs border border-white/20">
        ...
        <div className="p-6">
          <div className="flex items-start justify-between mb-3">
            ...
            {resource.rating && (
              <div className="flex items-center gap-1 text-yellow-400">
                ...
                <span className="text-sm font-semibold text-slate-300">{resource.rating}</span>
              </div>
            )}
          </div>
          ...
          {resource.specs && (
            <div className="bg-slate-700/50 rounded-lg p-3 mb-4 border border-slate-600">
              <h4 className="text-xs font-semibold text-slate-200 mb-2">Spécifications clés</h4>
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-wrap gap-1">
              {resource.tags?.slice(0, 3).map(tag => (
                <span key={tag} className="px-2 py-1 bg-blue-900/50 text-blue-300 rounded-md text-xs border border-blue-700">
                  {tag}
                </span>
              ))}
            </div>
    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-300">Chargement des ressources horlogères...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-slate-900 text-slate-100">
      ...
      <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white relative overflow-hidden">
        ...
        <img 
          src="/imgs/mouvements_header.png" 
      ...
      <div className="px-6 py-8">
        {/* Navigation & Filtres */}
        <div className="bg-slate-800 rounded-2xl shadow-lg border border-slate-700 p-6 mb-8">
          {/* Onglets */}
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-lg border border-slate-600 bg-slate-900 text-slate-100 placeholder:text-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            ...
            <div className="flex gap-4">
              <select
                ...
                className="px-4 py-3 rounded-lg border border-slate-600 bg-slate-900 text-slate-100 focus:ring-2 focus:ring-blue-500"
              >
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <select 
              ...
              className="text-sm border border-slate-600 rounded px-2 py-1 bg-slate-800 text-slate-100"
            >
