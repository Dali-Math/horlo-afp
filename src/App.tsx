...
import { 
  ...
  Heart, TrendingUp, Target, Shield
} from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const allResources: Resource[] = [
    // Marques Légendaires
    {
      ...
      views: 2847,
      rating: 4.9,
      image: '/images/marques_header.png',
    ...
    },
    {
      ...
      views: 3156,
      rating: 4.9,
      image: '/images/patek_calatrava.png',
    ...
    // Calibres Techniques
    {
      ...
      views: 4521,
      rating: 4.5,
      image: '/images/eta7750_chronographe.png',
    ...
    },
    {
      ...
      views: 1892,
      rating: 4.6,
      image: '/images/mouvements_header.png',
    ...
    },
    {
      ...
      views: 1567,
      rating: 4.7,
      image: '/images/jaeger_lecoultre_889.png',
    ...
    // Complications Avancées
    {
      ...
      views: 5234,
      rating: 4.9,
      image: '/images/tourbillon_breguet.png',
    ...
    },
    {
      ...
      views: 3421,
      rating: 4.8,
      image: '/images/complications_header.png',
    ...
    // Formation Professionnelle
    {
      ...
      views: 2145,
      rating: 4.9,
      image: '/images/formation_header.png',
    ...
    },
    {
      ...
      views: 3421,
      rating: 4.8,
      image: '/images/chronoscope_swiss_made.png',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white relative overflow-hidden">
        ...
        <img 
          src="/images/mouvements_header.png" 
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex gap-4">
              <select
                ...
                className="px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500"
              >
      ...
      <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 py-16">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-blue-900 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-blue-800 transition-all shadow-lg">
