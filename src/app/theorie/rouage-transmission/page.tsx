      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        >
          ...
          <div className="space-y-4 text-lg leading-relaxed">
            <p>
              Le <strong>rouage</strong> (ou train d'engrenages) est l'ensemble des roues dentées et pignons qui transmettent l'énergie du barillet vers l'échappement dans une montre mécanique. Il constitue le système de transmission cinématique central du mouvement horloger.
            </p>
            <p>
              Le rouage transforme le flux d'énergie continu provenant du ressort moteur en un mouvement régulé et précis. Chaque engrenage est conçu et apparié avec précision pour réguler le mouvement et la vitesse de transmission.
            </p>
            <p>
              Le train de rouage commence au niveau du ressort dans le barillet et se termine à l'échappement. Chaque roue du train est reliée à une autre par l'intermédiaire de pignons, ce qui permet de réduire progressivement la vitesse de transfert de l'énergie.
            </p>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="space-y-4 text-lg leading-relaxed">
            <p>
              Le <strong>rouage de finissage</strong> est un rouage multiplicatif, ce qui signifie que chaque mobile tourne plus rapidement que celui qui le précède dans la chaîne cinématique. Cette accélération progressive est essentielle pour atteindre la fréquence d'oscillation nécessaire au balancier.
            </p>
            <p>
            ...
            <p>
              L'efficience du train de rouage permet aux mouvements modernes de fonctionner à des fréquences élevées (jusqu'à 5 Hz pour certains calibres) tout en offrant un remarquable niveau de performance.
            </p>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="space-y-4 text-lg leading-relaxed">
            <p>
              Un train de rouage standard se compose généralement de <strong>quatre mobiles principaux</strong>. Chaque mobile est constitué d'une roue dentée et d'un pignon qui engrène avec la roue suivante.
            </p>
            ...
            <p>
              Dans le rouage, un engrenage se compose d'une roue dont les dents pénètrent entre les dents (appelées ailes) d'un pignon. Cette interaction mécanique permet une transmission précise du mouvement et du couple moteur.
            </p>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="space-y-4 text-lg leading-relaxed">
            <p>
              Dans un train d'engrenages simple, le <strong>rapport de transmission</strong> est égal au produit des nombres de dents des roues menantes divisé par celui des roues menées. Cette formule mathématique permet de calculer précisément les vitesses de rotation.
            </p>
            ...
            <p>
              Ce calcul permet aux horlogers de concevoir des trains de rouage qui produisent exactement les rapports de vitesse nécessaires pour une mesure précise du temps. La précision de ces engrenages est cruciale pour la fiabilité de la montre.
            </p>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="space-y-4 text-lg leading-relaxed">
            <p>
              Le <strong>rouage des minutes</strong> est un système spécifique qui transmet la rotation du pignon des minutes à l'aiguille des heures. Ce mécanisme assure que l'aiguille des heures tourne 12 fois plus lentement que celle des minutes.
            </p>
            <p>
              La minuterie est un ensemble d'engrenages situé côté cadran qui permet l'affichage des heures. Elle reçoit le mouvement de la roue de centre (qui fait un tour par heure) et le démultiplie pour actionner l'aiguille des heures.
            </p>
            <p>
              Les rouages transmettent également le couple moteur et le mouvement de l'organe moteur vers d'autres éléments du mécanisme, comme les complications horlogères (quantième, phases de lune, chronographe). Cette transmission doit être à la fois efficace et précise pour garantir le bon fonctionnement de toutes les fonctions.
            </p>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="space-y-4 text-lg leading-relaxed">
            <p>
              La qualité du rouage est déterminante pour la <strong>précision</strong> et la fiabilité d'une montre mécanique. Chaque engrenage doit être usiné avec une tolérance de l'ordre du micromètre pour assurer une transmission optimale.
            </p>
            <p>
              Le mouvement final des engrenages est converti en un tic-tac régulier de la montre qui donne une heure précise. Toute imperfection dans la conception ou la fabrication du rouage peut entraîner des variations de marche et affecter la précision chronométrique.
            </p>
            <p>
