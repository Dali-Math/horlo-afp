...
export default function CraftsmanshipPage() {
  ...
  const masteryObserverRef = useRef<IntersectionObserver | null>(null);
  ...
  useEffect(() => {
    ...
    masteryObserverRef.current = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
    ...
    document.querySelectorAll('.mastery-indicator').forEach(el => {
      masteryObserverRef.current?.observe(el);
    });
    ...
    return () => {
      ...
      masteryObserverRef.current?.disconnect();
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Chaque montre Patek Philippe est le fruit de siècles de tradition horlogère et d'un artisanat d'exception" />
      ...
      <div className="text-gray-800">
        ...
        <nav className="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex space-x-8">
                ...
                <a href="/craftsmanship" className="nav-link text-yellow-600 font-semibold">Savoir-faire</a>
          ...
          <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} md:hidden bg-white border-t border-gray-200`}>
            <div className="px-6 py-4 space-y-4">
              ...
              <a href="/craftsmanship" className="block text-yellow-600 font-semibold">Savoir-faire</a>
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
          <div id="vanta-bg" ref={vantaRef} className="vanta-bg"></div>
