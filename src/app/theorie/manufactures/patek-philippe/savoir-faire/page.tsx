        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="craft-card rounded-xl p-8 scroll-reveal">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">Mouvements Mécaniques</h3>
              <p className="text-gray-600 text-center mb-6">
                Des complications horlogères parmi les plus complexes au monde, fabriquées et assemblées à la main.
              </p>
              <div className="space-y-4">
                <div className="mastery-indicator">
                  <div className="flex justify-between mb-2">
                    <span className="text-sm text-gray-700">Rattrapante chronographe</span>
                ...
                <div className="mastery-indicator">
                  <div className="flex justify-between mb-2">
                    <span className="text-sm text-gray-700">Calendrier perpétuel</span>
                    <span className="text-sm font-semibold text-yellow-600">100%</span>
                  </div>
                  <div className="mastery-progress" style={{width: '100%'}}></div>
                </div>
                <div className="mastery-indicator">
                  <div className="flex justify-between mb-2">
                    <span className="text-sm text-gray-700">Sonnerie miniatures</span>
                    <span className="text-sm font-semibold text-yellow-600">100%</span>
                  </div>
                  <div className="mastery-progress" style={{width: '100%'}}></div>
                </div>
            ...
            <div className="craft-card rounded-xl p-8 scroll-reveal">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">Finitions Manuelles</h3>
              <p className="text-gray-600 text-center mb-6">
                Des décors uniques sur chaque composant, visibles ou cachés, témoignant du savoir-faire ancestral.
              </p>
              <div className="space-y-4">
                <div className="mastery-indicator">
                  <div className="flex justify-between mb-2">
                    <span className="text-sm text-gray-700">Côtes de Genève</span>
                    <span className="text-sm font-semibold text-yellow-600">100%</span>
                  </div>
                  <div className="mastery-progress" style={{width: '100%'}}></div>
                </div>
                <div className="mastery-indicator">
                  <div className="flex justify-between mb-2">
                    <span className="text-sm text-gray-700">perlage angulaire</span>
                    <span className="text-sm font-semibold text-yellow-600">100%</span>
                  </div>
                  <div className="mastery-progress" style={{width: '100%'}}></div>
                </div>
                <div className="mastery-indicator">
                  <div className="flex justify-between mb-2">
                    <span className="text-sm text-gray-700">Biseautage poli</span>
                    <span className="text-sm font-semibold text-yellow-600">100%</span>
                  </div>
                  <div className="mastery-progress" style={{width: '100%'}}></div>
                </div>
