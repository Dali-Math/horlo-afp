        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          <div className="floating-element">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button 
                onClick={() => window.location.href = 'heritage.html'} 
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="watch-card rounded-xl p-6 scroll-reveal">
              ...
              <button 
                onClick={() => window.location.href = 'collections.html#nautilus'} 
            ...
            <div className="watch-card rounded-xl p-6 scroll-reveal">
              ...
              <button 
                onClick={() => window.location.href = 'collections.html#calatrava'} 
                className="text-yellow-600 font-semibold hover:text-yellow-700 transition-colors"
              >
                Explorer la collection <i className="fas fa-arrow-right ml-1"></i>
              </button>
            ...
            <div className="watch-card rounded-xl p-6 scroll-reveal">
              ...
              <button 
                onClick={() => window.location.href = 'collections.html#complications'} 
                className="text-yellow-600 font-semibold hover:text-yellow-700 transition-colors"
              >
                Explorer la collection <i className="fas fa-arrow-right ml-1"></i>
              </button>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="scroll-reveal">
              ...
              <button 
                onClick={() => window.location.href = 'craftsmanship.html'} 
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mt-12 scroll-reveal">
            <button 
              onClick={() => window.location.href = 'innovation.html'} 
              className="bg-yellow-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-yellow-700 transition-all duration-300"
            >
