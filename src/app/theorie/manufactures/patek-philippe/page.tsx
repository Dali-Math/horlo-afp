      ...
      <nav className="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="#home" className="nav-link text-gray-700 hover:text-yellow-600">Accueil</a>
        ...
        <div className={`${mobileMenuOpen ? '' : 'hidden'} md:hidden bg-white border-t border-gray-200`}>
          <div className="px-6 py-4 space-y-4">
            <a href="#home" className="block text-gray-700 hover:text-yellow-600">Accueil</a>
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          <div className="floating-element">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/collections" className="bg-yellow-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-yellow-700 transition-all duration-300 transform hover:scale-105">
                Découvrir les Collections
              </Link>
              <Link href="/heritage" className="border-2 border-yellow-600 text-yellow-600 px-8 py-4 rounded-full font-semibold hover:bg-yellow-600 hover:text-white transition-all duration-300">
                Notre Héritage
              </Link>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="watch-card rounded-xl p-6 scroll-reveal">
              <div className="aspect-square mb-6 overflow-hidden rounded-lg">
                <img src="https://images.unsplash.com/photo-1524805444758-089113d48a6d?w=400&h=400&fit=crop" 
                     alt="Nautilus" 
              ...
              <Link href="/collections#nautilus" className="text-yellow-600 font-semibold hover:text-yellow-700 transition-colors">
            ...
            <div className="watch-card rounded-xl p-6 scroll-reveal">
              <div className="aspect-square mb-6 overflow-hidden rounded-lg">
                <img src="https://images.unsplash.com/photo-1547996160-81dfa63595aa?w=400&h=400&fit=crop" 
                     alt="Calatrava" 
                     className="w-full h-full object-cover hover:scale-110 transition-transform duration-500"/>
              </div>
              ...
              <Link href="/collections#calatrava" className="text-yellow-600 font-semibold hover:text-yellow-700 transition-colors">
                Explorer la collection <i className="fas fa-arrow-right ml-1"></i>
              </Link>
            </div>
            ...
            <div className="watch-card rounded-xl p-6 scroll-reveal">
              <div className="aspect-square mb-6 overflow-hidden rounded-lg">
                <img src="https://images.unsplash.com/photo-1612817159949-195b619eb547?w=400&h=400&fit=crop" 
              ...
              <Link href="/collections#complications" className="text-yellow-600 font-semibold hover:text-yellow-700 transition-colors">
                Explorer la collection <i className="fas fa-arrow-right ml-1"></i>
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="scroll-reveal">
              ...
              <Link href="/craftsmanship" className="bg-yellow-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-yellow-700 transition-all duration-300 inline-block">
                Découvrir le savoir-faire
              </Link>
            </div>
            <div className="scroll-reveal">
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1495856452204-15f959c2b5b1?w=800&h=600&fit=crop" 
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mt-12 scroll-reveal">
            <Link href="/innovation" className="bg-yellow-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-yellow-700 transition-all duration-300 inline-block">
