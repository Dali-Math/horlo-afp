...
const collections = [
  {
    id: 'nautilus',
    name: 'Nautilus',
    description: "Conçu par Gérald Genta en 1976, le Nautilus est devenu l'icône du luxe sportif. Sa forme distinctive en hublot et son intégration parfaite du bracelet en font un symbole intemporel de l'élégance sportive.",
  ...
  },
  {
    ...
    image: '/images/patek/calatrava.jpg',
    category: 'classic',
    badge: 'Classique',
  ...
  },
  {
    ...
    image: '/images/patek/complications.jpg',
  ...
  },
  {
    ...
    image: '/images/patek/aquanaut.jpg',
    category: 'sport',
    badge: 'Sport',
    badgeColor: 'bg-yellow-600',
    specs: {
  ...
  },
  {
    ...
    image: '/images/patek/gondolo.jpg',
    category: 'classic',
    badge: 'Classique',
    badgeColor: 'bg-gray-600',
    specs: {
  ...
  },
  {
    ...
    image: '/images/patek/twenty4.jpg',
    category: 'classic',
    badge: 'Classique',
    badgeColor: 'bg-gray-600',
    specs: {
