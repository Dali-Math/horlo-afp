        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <button onClick={() => router.push('/innovation')} className="nav-link text-yellow-600 font-semibold">Innovation</button>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200">
            <div className="px-6 py-4 space-y-4">
              ...
              <button onClick={() => router.push('/innovation')} className="block text-yellow-600 font-semibold">Innovation</button>
            </div>
          </div>
        )}
      </nav>
