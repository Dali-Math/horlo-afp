  ...
  collections: [
    {
      ...
      description: "Créée en 1953, première montre étanche à 100m. Aujourd'hui 300m avec lunette Cerachrom unidirectionnelle, cadran Chromalight et précision -2/+2 sec/jour.",
      ...
      category: "sport",
      market: "Fort surcot sur le marché secondaire"
    },
    {
      id: "daytona",
      name: "Cosmograph Daytona",
      nickname: "La montre des champions",
      description: "Chronographe légendaire créé pour les pilotes de course. Compteurs 3-6-9, échelle tachymétrique sur lunette, mouvement 4130 avec roue à colonnes.",
      ...
      category: "sport",
      market: "Valeur ×2 à ×5 au-dessus du prix boutique"
    },
    {
      id: "gmt-master-ii",
      name: "GMT-Master II",
      nickname: "La montre des globe-trotters",
      description: "Deux fuseaux horaires avec aiguille indépendante. Lunette bicolore emblématique Bleu/Rouge (Pepsi) ou Bleu/Noir (Batman).",
      ...
      category: "aviation",
      market: "Modèles vintage très recherchés"
    },
    {
      id: "datejust",
      name: "Oyster Perpetual Datejust",
      nickname: "L'emblématique",
      description: "La montre classique par excellence depuis 1945. Date à 3h avec loupe Cyclope, bracelet Jubilee ou Oyster au choix.",
      ...
      category: "classique",
      market: "Valeur stable, bonne liquidité"
    },
    {
      id: "day-date",
      name: "Oyster Perpetual Day-Date",
      nickname: "La montre des Présidents",
      description: "Affiche jour complet en toutes lettres et date. Créée en 1956 pour les leaders mondiaux. Bracelet President exclusif.",
      ...
      category: "classique",
      market: "Dépréciation d'or plein, mais Day-Date 40 en acier rare"
    },
    {
      id: "explorer",
      name: "Oyster Perpetual Explorer",
      nickname: "L'aventure incarnée",
      description: "Montre de l'Everest 1953. Robustesse extrême, lisibilité parfaite dans l'obscurité avec Chromalight. Boîtier 36mm ou 40mm.",
      ...
      category: "sport",
      market: "Modèle 36mm très demandé, bon investissement"
    },
    {
      id: "yacht-master",
      name: "Yacht-Master",
      nickname: "L'esprit nautique",
      description: "Montre de voile luxueuse. Lunette Cerachrom graduée, bracelet Oysterflex en caoutchouc sur lame métallique.",
      ...
      category: "sport",
      market: "Moins surcoté que les autres sportives"
    },
    {
      id: "sea-dweller",
      name: "Sea-Dweller",
      nickname: "Le plongeur professionnel",
      description: "Étanche à 1'220m avec valve à hélium. Pour plongeurs en saturation. Boîtier 43mm, bracelet Oyster avec extension Fliplock.",
      ...
      category: "sport",
      market: "Modèle historique très recherché"
    },
    {
      id: "milgauss",
      name: "Milgauss",
      nickname: "L'anti-magnétique",
      description: "Résiste à 1'000 gauss. Créée pour les ingénieurs du CERN. Éclairage vert emblématique sur cadran noir.",
      ...
      market: "Production arrêtée, montée en valeur"
    },
    {
      id: "air-king",
      name: "Air-King",
      nickname: "L'hommage à l'aviation",
      description: "Tribute à l'épopée de l'aviation. Cadran spécial avec 'Air-King' typographie et aiguilles vertes vives.",
      ...
      category: "aviation",
      market: "Prix accessible, bon rapport qualité"
    },
    {
      id: "oyster-perpetual",
      name: "Oyster Perpetual",
      nickname: "L'essence de Rolex",
      description: "La base de toutes les Rolex. Sans complications, juste la perfection horlogère. Disponible en 5 tailles de 28 à 41mm.",
      ...
      category: "classique",
      market: "Meilleur rapport qualité/prix de la gamme"
    },
    {
      id: "sky-dweller",
      name: "Sky-Dweller",
      nickname: "La plus complexe des Rolex",
      description: "Calendrier annuel Saros, deux fuseaux. Pour globe-trotters exigeants. Boîtier 42mm, lunette Ring Command rotative.",
      ...
      market: "Haut de gamme technique, bon investissement"
    }
  ],
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2b/Rolex_Submariner_Date_16610.jpg/1200px-Rolex_Submariner_Date_16610.jpg",
        width: 1200,
        height: 800,
        alt: "Rolex Submariner - Manufacture Horlogère Suisse"
      }
    ],
    type: "article",
    locale: "fr_CH",
  ...
  alternates: {
    canonical: "https://www.horlolearn.ch/theorie/manufactures/rolex"
  }
};
        ...
        {ROLEX_DATA.collections.map((col) => (
          <div key={col.id} className="group bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all h-full flex flex-col">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <div className="space-y-2 mb-4 text-sm border-t border-b border-slate-200 dark:border-slate-700 py-3">
              ...
              <div className="mt-auto pt-4 border-t border-slate-200 dark:border-slate-700">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-xs text-slate-500 dark:text-slate-400">{col.market}</span>
...
const Pricing = () => (
  <section className="py-20 bg-slate-50 dark:bg-slate-800">
    <div className="max-w-7xl mx-auto px-6">
      <h2 className="text-4xl font-bold text-center mb-4 dark:text-white">{ROLEX_DATA.pricing.title}</h2>
      <p className="text-center text-slate-600 dark:text-slate-400 max-w-3xl mx-auto mb-8">{ROLEX_DATA.pricing.intro}</p>
      <p className="text-center text-sm text-slate-500 mb-12">{ROLEX_DATA.pricing.intro2}</p>
        ...
        <table className="w-full bg-white dark:bg-slate-900 rounded-xl overflow-hidden shadow-lg">
          <thead className="bg-slate-900 dark:bg-slate-700 text-white">
            <tr>
              ...
              <th className="p-4 text-center">Marché</th>
            </tr>
          </thead>
          <tbody>
            {ROLEX_DATA.pricing.categories.map((cat, i) => (
              <tr key={i} className="border-b border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800">
                ...
                <td className="p-4 text-sm">{cat.models}</td>
                ...
                <td className="p-4 text-center text-sm text-slate-600 dark:text-slate-400">{cat.market}</td>
              </tr>
            ))}
          </tbody>
        </table>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <ul className="text-sm space-y-1 text-slate-600 dark:text-slate-400">
              ...
              <li>• Complications rares (Sky-Dweller)</li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="text-sm space-y-1 text-slate-600 dark:text-slate-400">
              ...
              <li>• Bulle spéculative possible</li>
            </ul>
          </div>
        </div>
        <p className="mt-6 text-sm text-slate-500">{ROLEX_DATA.pricing.investment}</p>
        <p className="mt-2 text-xs text-slate-600 dark:text-slate-400">{ROLEX_DATA.pricing.tips}</p>
      </div>
    </div>
  </section>
);
    ...
    <main className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <footer className="py-12 bg-slate-950 text-white text-center">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-sm text-slate-400">Images : Wikimedia Commons (libres de droits) | {ROLEX_DATA.legal.note}</p>
