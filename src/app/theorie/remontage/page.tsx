    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-950 dark:to-slate-900 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {!showQuiz ? (
          <>
            {/* Section 1 */}
            <section className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 mb-6 border border-slate-200 dark:border-slate-700">
              <div className="flex items-center mb-4">
                <RotateCw className="w-8 h-8 text-blue-600 dark:text-blue-400 mr-3" />
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Principe du Remontage</h2>
              </div>
            ...
            <section className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 mb-6 border border-slate-200 dark:border-slate-700">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">La Tige de Remontoir</h2>
              </div>
              <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <section className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 mb-6 border border-slate-200 dark:border-slate-700">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">La Roue de Couronne</h2>
              </div>
              <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <section className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 mb-6 border border-slate-200 dark:border-slate-700">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Le Cliquet Anti-Retour</h2>
              </div>
              <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <section className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 mb-6 border border-slate-200 dark:border-slate-700">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Remontage Manuel vs Automatique</h2>
              </div>
              <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <section className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 mb-6 border border-slate-200 dark:border-slate-700">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Précautions et Entretien</h2>
              </div>
              <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <div className="text-center">
              <button
                ...
                className="bg-blue-600 dark:bg-blue-500 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors shadow-lg"
              >
