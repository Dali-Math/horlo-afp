...
export default function CartoucheHorloger() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800 py-12 px-6">
      ...
      {/* Bloc schéma */}
      <section className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 mb-12 border border-gray-200">
        ...
        <div className="flex justify-center">
          ...
          >
            <Image
              ...
              width={700}
              height={300}
              className="rounded-lg border shadow-sm cursor-pointer hover:shadow-md transition"
        ...
        <p className="text-center text-gray-600 text-sm mt-3">
          Cliquez sur l’image pour agrandir ou réduire légèrement
        </p>
      </section>
