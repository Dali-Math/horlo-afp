...
export default function PratiquePage() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-950 dark:to-slate-900 text-slate-900 dark:text-white transition-colors duration-500 py-16 px-6">
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-blue-600 dark:text-blue-400 mb-10">
          Pratique Horlogère
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          {sections.map((s, i) => (
            <Link
              ...
              className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 text-left hover:scale-[1.02] transition-all shadow-md hover:shadow-xl hover:border-blue-400 dark:hover:border-blue-500"
            >
        ...
        {/* Section Flashcards */}
        <div className="mt-24">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-600 dark:text-blue-400 mb-8">
