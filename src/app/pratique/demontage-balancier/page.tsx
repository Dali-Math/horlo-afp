...
export default function DemontageBalancier() {
  const steps = [
    { name: "Préparer l'établi", text: "Équipe-toi d'une brucelle antimagnetique et d'un porte-mouvement." },
    ...
    <section className="max-w-3xl mx-auto p-6">
      <BreadcrumbsSchema
        items={[
          ...
          { name: "Démontage du balancier", slug: "pratique/demontage-balancier" },
        ]}
      />
