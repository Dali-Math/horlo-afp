...
export default function VueAssemblage() {
  ...
  const pages = [
    ...
    },
    {
      ...
      pieces: [
        { id: "902 VAR", nom: "Vis de pont (gauche)", x: 37, y: 72 },
        { id: "902 VAR", nom: "Vis de pont (centre)", x: 153, y: 35 },
        { id: "902 VAR", nom: "Vis de pont (droite)", x: 276, y: 43 },
        { id: "18 VAR", nom: "Pont de barillet", x: 188, y: 198 },
        { id: "17 VAR", nom: "Tambour de barillet", x: 216, y: 262 },
        { id: "905 VAR", nom: "Cliquet", x: 431, y: 107 },
        { id: "23 VAR", nom: "Roue de couronne", x: 459, y: 173 },
        { id: "904 VAR", nom: "Vis de bride", x: 406, y: 237 },
        { id: "22", nom: "Rochet", x: 401, y: 287 },
        { id: "21", nom: "Bride", x: 338, y: 329 },
        { id: "903 VAR", nom: "Vis de rochet", x: 474, y: 330 },
        { id: "20 VAR", nom: "Ressort de barillet", x: 486, y: 380 },
        { id: "19", nom: "Arbre de barillet", x: 458, y: 430 },
      ]
    },
    {
      id: 5,
