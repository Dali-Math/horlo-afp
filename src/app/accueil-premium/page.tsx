...
export default function VueAssemblage() {
  ...
  const pages = [
    ...
    },
    {
      ...
      pieces: [
        { id: '902 VAR', nom: 'Vis de coq', x: 72, y: 2 },
        { id: '28 VAR', nom: 'Ellipse', x: 70, y: 10 },
        { id: '28-5', nom: 'Spiral flat overcoil', x: 39, y: 9 },
        { id: '28-4', nom: 'Spiral Breguet', x: 33, y: 17 },
        { id: '28-3', nom: 'Spiral plat', x: 27, y: 23 },
        { id: '27', nom: 'Double plateau rivé', x: 88, y: 24 },
        { id: '28-2', nom: 'Stud', x: 34, y: 29 },
        { id: '28-1 VAR', nom: 'Virole', x: 31, y: 36 },
        { id: '24 VAR', nom: 'Balancier seul', x: 14, y: 54 },
        { id: '906 VAR', nom: 'Chaton (haut)', x: 69, y: 60 },
        { id: '906 VAR', nom: 'Chaton (bas)', x: 90, y: 63 },
        { id: '26 VAR', nom: 'Grande plateau', x: 90, y: 68 },
        { id: '25', nom: 'Petite plateau', x: 85, y: 76 },
      ]
    },
    {
      id: 6,
