...
export default function VueAssemblage() {
  ...
  pieces: [
    ...
    },
    {
      ...
      pieces: [
        { id: '902 VAR', nom: 'Vis de pont (gauche)', x: 8, y: 12 },
        { id: '902 VAR', nom: 'Vis de pont (centre)', x: 20, y: 7 },
        { id: '902 VAR', nom: 'Vis de pont (droite)', x: 35, y: 7 },
        { id: '18 VAR', nom: 'Pont de barillet', x: 30, y: 31 },
        { id: '17 VAR', nom: 'Tambour de barillet', x: 18, y: 42 },
        { id: '905 VAR', nom: 'Cliquet', x: 68, y: 17 },
        { id: '23 VAR', nom: 'Roue de couronne', x: 70, y: 25 },
        { id: '904 VAR', nom: 'Vis de bride', x: 62, y: 35 },
        { id: '22', nom: 'Rochet', x: 56, y: 44 },
        { id: '21', nom: 'Bride', x: 48, y: 50 },
        { id: '903 VAR', nom: 'Vis de rochet', x: 68, y: 50 },
        { id: '20 VAR', nom: 'Ressort de barillet', x: 72, y: 60 },
        { id: '19', nom: 'Arbre de barillet', x: 68, y: 68 },
      ]
    },
    {
      id: 5,
