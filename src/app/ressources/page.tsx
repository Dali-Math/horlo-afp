        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <a href="https://www.hautehorlogerie.org/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">www.hautehorlogerie.org</a>
            </div>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <a href="https://archive.org/search.php?query=watchmaking+horology" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">archive.org/horlogerie</a>
            </div>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <a href="https://wostep.ch/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">wostep.ch</a>
            </div>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <a href="https://www.timezone.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">timezone.com</a>
            </div>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <a href="http://www.ranfft.de/cgi-bin/bidfun-db.cgi?10&ranfft&&2uswk" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">ranfft.de</a>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <a href="https://www.fhs.swiss/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">fhs.swiss</a>
            </div>
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <a href="https://www.omegawatches.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">omegawatches.com</a>
            </div>
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <a href="https://watch-wiki.org/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">watch-wiki.org</a>
            </div>
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <a href="https://nawcc.org/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">nawcc.org</a>
            </div>
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <a href="https://www.hautehorlogerie.org/en/encyclopaedia/lexicon-glossary/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">FHH Lexique</a>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-purple-500 pl-4">
              ...
              <a href="https://www.nihs.ch/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">nihs.ch</a>
            </div>
            ...
            <div className="border-l-4 border-purple-500 pl-4">
              ...
              <a href="https://www.iso.org/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">iso.org</a>
            </div>
            ...
            <div className="border-l-4 border-purple-500 pl-4">
              ...
              <a href="https://www.cosc.swiss/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">cosc.swiss</a>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-orange-500 pl-4">
              ...
              <a href="https://www.cousinsuk.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">cousinsuk.com</a>
            </div>
            ...
            <div className="border-l-4 border-orange-500 pl-4">
              ...
              <a href="https://www.boley.de/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">boley.de</a>
            </div>
            ...
            <div className="border-l-4 border-orange-500 pl-4">
              ...
              <a href="https://www.eta.ch/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">eta.ch</a>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-red-500 pl-4">
              ...
              <a href="https://www.cpih.ch/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">cpih.ch</a>
            </div>
            ...
            <div className="border-l-4 border-red-500 pl-4">
              ...
              <a href="https://www.georgedaniels.co.uk/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">georgedaniels.co.uk</a>
            </div>
            ...
            <div className="border-l-4 border-red-500 pl-4">
              ...
              <a href="https://bhi.co.uk/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">bhi.co.uk</a>
            </div>
            ...
            <div className="border-l-4 border-red-500 pl-4">
              ...
              <a href="https://archive.org/details/practicalwatchre00deca" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">archive.org/practicalwatch</a>
            </div>
          </div>
        </section>
      </div>
