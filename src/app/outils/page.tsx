    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 py-12 px-4">
      <div className="space-y-6 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-3">Calculateur COSC ISO 3159</h1>
          <p className="text-slate-400 text-lg">Certification des chronomètres mécaniques suisses</p>
        </div>
        ...
        <div className="bg-slate-800/80 border-2 border-blue-500/50 rounded-xl p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white">SAISIE DES DONNÉES</h3>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="bg-slate-900/50 p-4 rounded-lg">
                ...
                <p className="text-xs text-slate-400 mb-4">Saisir la marche journalière en secondes/jour pour chaque position</p>
            ...
            <div className="space-y-4">
              <div className="bg-slate-900/50 p-4 rounded-lg">
                ...
                <p className="text-xs text-slate-400 mb-4">Mesures de marche aux différentes températures</p>
              ...
              {/* Critères ISO 3159 */}
              <div className="bg-slate-900/50 p-4 rounded-lg">
                <h4 className="text-lg font-semibold text-white mb-3">Critères ISO 3159 (Cat. 1)</h4>
