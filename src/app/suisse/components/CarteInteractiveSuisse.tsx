...
function Tooltip({ canton, position, onClose }: TooltipProps) {
  ...
  return (
    <motion.div
      ...
      className="absolute z-50 bg-[#1A1A1A] border border-[#E2B44F] rounded-lg p-4 shadow-2xl w-64 max-w-xs"
      style={{
...
export default function CarteInteractiveSuisse() {
  ...
  const handleCantonClick = (
    canton: keyof typeof cantonData,
    event: React.MouseEvent<SVGCircleElement | SVGTextElement, MouseEvent>
  ) => {
        ...
        <div className="bg-[#1A1A1A] p-8 rounded-lg border border-[#E2B44F]/20 relative overflow-hidden">
          ...
          <div className="relative flex justify-center">
            <svg
              ...
              style={{
                filter:
                  "drop-shadow(0 0 20px rgba(226, 180, 79, 0.3))",
              }}
            >
          ...
          <div className="mt-8 text-center">
            ...
            <div className="flex justify-center gap-3 text-sm text-[#E2B44F]">
