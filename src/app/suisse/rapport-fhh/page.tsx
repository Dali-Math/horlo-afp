      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
        ...
        <div>
          ...
          <p className="text-gray-300 leading-relaxed mb-6">
            Le Rapport FHH 2024 présente les chiffres clés, les tendances et les
            perspectives de l’industrie horlogère suisse. Il s’agit d’une
            ressource précieuse pour comprendre l’évolution du secteur et ses
